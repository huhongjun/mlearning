 ...
 *******************************************************************************/
package com.zj.support.widget.refresh;
...
import com.zj.support.widget.refresh.PullToRefreshBase.Orientation;
import com.zj.support.widget.refresh.inter.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		default:
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableStart)) {
				...
				Log.w(LOG_TAG,
						"You're using the deprecated ptrDrawableTop  attr, please switch over to ptrDrawableStart");
				imageDrawable = attrs
		...
		case PULL_FROM_END:
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableEnd)) {
				...
				Log.w(LOG_TAG,
						"You're using the deprecated ptrDrawableBottom  attr, please switch over to ptrDrawableEnd");
				imageDrawable = attrs
		...
		// Add by XingRongJing 2014-5-14
		if (attrs.hasValue(R.styleable.PullToRefresh_ptrIndeterminateDrawable)) {
			Drawable proBarDrawable = attrs
					.getDrawable(R.styleable.PullToRefresh_ptrIndeterminateDrawable);
			this.setProgressBarStyle(proBarDrawable);
		}
	...
	private void setProgressBarStyle(Drawable d) {
