...
import com.zj.support.widget.refresh.inter.IPullToRefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	public boolean isHeaderShown() {
		return this.getHeaderLayout().isShown();
	}

	// Add by XingRongJing
	public boolean isFooterShown() {
		return this.getFooterLayout().isShown();
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			...
			Log.w(LOG_TAG,
					"You're using the deprecated ptrAdapterViewBackground  attr, please switch over to ptrRefreshableViewBackground");
			Drawable background = a
