package com.zhijin.mlearning.app.api.json;
...
public class JsonUtil
{
	...
	// public static Object getObjectJsonString(String jsonString, Class
	// pojoCalss) {
	// Object pojo;
	...
	// public static Object getObjectJsonObjectString(JSONObject jsonObject,
	// Class pojoCalss) {
	// Object pojo;
	// pojo = JSONObject.toBean(jsonObject, pojoCalss);
	// return pojo;
